...
BOT_TOKEN = '5418809404:AAEzdhFQ-XUn6M8HFrlGaD7J6NTp20I0gRE'      # Токен бота

CODE_ACCESS = 'TEST'    # код по которому можно будет давать доступ в итоге код получится TESTГОД-МЕСЯЦ-ЧИСЛО (TEST2020-01-01)

BOT_LOGIN = 'https://t.me/cryptoUpp_bot'          # login бота, например: telegram_bot

ADMIN_ID = 798167379       # id админа
